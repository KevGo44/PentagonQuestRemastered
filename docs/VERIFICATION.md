...
Maven erstellt die eigenständig startbare JAR und führt **68 automatisierte Tests** aus:
...
| Schreinfeuer, Höhlenmodule, Endstand | `verify-smoke-hoehlen.log`, `verify-smoke-final3.log`, `cave_builder.log`, `roomshots-caves2.log` | BUILD SUCCESS, **68 Tests**; Rauchlauf 42 Prüfungen; Bilder `target/probe-shots/room-caverns-*.png`, `room-refuge-1.png`, `target/screenshots/pentagon-11.png` (Epilog), `pentagon-13.png` (Falle) |
